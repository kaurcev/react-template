...
export default function TermOfUseView(){
    const { title, appSite } = useAppContext();
    document.title = `Правила использования | ${title}`;
        useEffect(()=>{
            window.scrollTo(0,0);
    }, [])    
    ...
    return (
        ...
        <Header />
            <main>
                ...
                <p>Настоящее Пользовательское Соглашение (Далее Соглашение) регулирует отношения между {appSite} (далее {appSite} или Администрация) с одной стороны и пользователем сайта с другой.</p>
                <p>Сайт {appSite} не является средством массовой информации.</p>
                <p>Используя сайт <b>ponytown.art</b>, Вы соглашаетесь с условиями данного соглашения.</p>
                <b>Если Вы не согласны с условиями данного соглашения, не используйте сайт {appSite}!</b>
